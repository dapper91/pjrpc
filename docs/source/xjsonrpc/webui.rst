...
``xjsonrpc`` supports integrated web UI as an extra dependency. Three UI types are supported:
...
To enable Web UI pass :py:class:`xjsonrpc.server.specs.openapi.SwaggerUI`, :py:class:`xjsonrpc.server.specs.openapi.RapiDoc` or
:py:class:`xjsonrpc.server.specs.openapi.ReDoc` to a specification generator as a ``ui`` parameter.
