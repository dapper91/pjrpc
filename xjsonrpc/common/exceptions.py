...
class JsonRpcErrorMeta(type):
    """
    :py:class:`xjsonrpc.common.exceptions.JsonRpcError` metaclass.
    Builds a mapping from an error code number to an error class
    inherited from a :py:class:`xjsonrpc.common.exceptions.JsonRpcError`.
    """
...
class JsonRpcError(BaseError, metaclass=JsonRpcErrorMeta):
    ...
    def from_json(cls, json_data: Json) -> 'JsonRpcError':
        ...
        :raises: :py:class:`xjsonrpc.common.exceptions.DeserializationError` if format is incorrect
        """
