...
class JsonRPC:
    ...
    def __init__(self, path: str, spec: Optional[specs.Specification] = None, **kwargs: Any):
        ...
        self._endpoints: Dict[str, xjsonrpc.server.Dispatcher] = {'': self._dispatcher}
    ...
    def add_endpoint(
        ...
        **kwargs: Any,
        ...
        dispatcher = xjsonrpc.server.Dispatcher(**kwargs)
    ...
    def _generate_spec(self) -> flask.Response:
        ...
        return current_app.response_class(
            ...
            mimetype=xjsonrpc.common.DEFAULT_CONTENT_TYPE,
        )
    ...
    def _rpc_handle(self, dispatcher: xjsonrpc.server.Dispatcher) -> flask.Response:
        ...
        if response_text is None:
            ...
            return current_app.response_class(response_text, mimetype=xjsonrpc.common.DEFAULT_CONTENT_TYPE)
