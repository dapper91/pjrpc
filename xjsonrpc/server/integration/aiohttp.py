...
class Application:
    ...
    async def _rpc_handle(self, http_request: web.Request, dispatcher: xjsonrpc.server.AsyncDispatcher) -> web.Response:
        """
        ...
        if http_request.content_type not in xjsonrpc.common.REQUEST_CONTENT_TYPES:
