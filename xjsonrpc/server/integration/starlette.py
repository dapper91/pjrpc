...
class Application:
    ...
    :param kwargs: arguments to be passed to the dispatcher :py:class:`xjsonrpc.server.AsyncDispatcher`
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._endpoints: Dict[str, xjsonrpc.server.AsyncDispatcher] = {'': self._dispatcher}
    ...
    @property
    def endpoints(self) -> Dict[str, xjsonrpc.server.Dispatcher]:
        """
    ...
    def add_endpoint(self, prefix: str, **kwargs: Any) -> xjsonrpc.server.Dispatcher:
        """
        ...
        dispatcher = xjsonrpc.server.AsyncDispatcher(**kwargs)
    ...
    async def _rpc_handle(self, http_request: Request, dispatcher: xjsonrpc.server.AsyncDispatcher) -> Response:
        """
        ...
        if http_request.headers['Content-Type'] not in xjsonrpc.common.REQUEST_CONTENT_TYPES:
        ...
        if response_text is None:
            ...
            return Response(content=response_text, media_type=xjsonrpc.common.DEFAULT_CONTENT_TYPE)
