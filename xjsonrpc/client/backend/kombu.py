...
import xjsonrpc
from xjsonrpc.common import UNSET
    ...
    def _request(self, request_text: str, is_notification: bool = False, **kwargs: Any) -> Optional[str]:
        ...
        def on_response(message: kombu.Message) -> None:
            ...
            try:
                ...
                if message.content_type not in xjsonrpc.common.RESPONSE_CONTENT_TYPES:
                    raise xjsonrpc.exc.DeserializationError(f"unexpected response content type: {message.content_type}")
                else:
