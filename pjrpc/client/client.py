...
class Batch:
    ...
    def __init__(self, client, strict=True):
        self._client = client
        self._strict = strict
        self._id_gen = client.id_gen_class()
    ...
    def __getitem__(self, requests):
        ...
        :return: request results as a tuple
        """
...
class AbstractClient(abc.ABC):
    ...
    :param id_gen_class: identifier generator class
    ...
    def __init__(
        ...
        id_gen_class=generators.sequential,
        ...
        self.id_gen_class = id_gen_class
